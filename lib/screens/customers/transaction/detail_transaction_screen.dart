...
class DetailTransactionCustomerScreen extends StatefulWidget {
  ...
  final double total;
  const DetailTransactionCustomerScreen({super.key, required this.txid, required this.customer, required this.driver, required this.pickupAddress, required this.destinationAddress, required this.pickupReturnAddress, required this.timePickup, required this.timeReturn, required this.start, required this.end, required this.total, required this.status});

  @override
  State<DetailTransactionCustomerScreen> createState() => _DetailTransactionCustomerScreenState();
}

class _DetailTransactionCustomerScreenState extends State<DetailTransactionCustomerScreen> {
